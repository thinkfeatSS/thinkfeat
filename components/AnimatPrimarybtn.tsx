...
const AnimatPrimarybtn = ({ text, onClick } : ButtonProps) => {
  return (
    ...
    <button className='py-2.5 px-6 rounded-full bg-secondary text-on-secondary dark:bg-primary dark:text-on-primary hover:bg-primary hover:text-on-primary dark:hover:bg-secondary dark:hover:text-on-secondary hover:shadow-lg transition-all ease-linear uppercase'
    onClick={onClick}
    >
      {text}  
    </button>
